...
const fp = flatpickr('.gp-date', {
    ...
    onClose: (selectedDates, dateStr, instance) => {
        ...
        const days = `'${startDay}' to the date '${endDay}'`;
...
// (from ${days}) 
// 'Day, Month Date Year': {
    const prompt = `Create a ${dayCount} day plan starting from the date ${days}.
    This is a day plan for ${firstTime}${city}${travelWith}${occasion} that includes ${hotel}${attractions ? ', '+attractions : ''}${otherAttractions ? ', '+otherAttractions : ''} and restaurants. 
