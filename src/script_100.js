...
function generatePrompt() {
    ...
    const prompt = `Create a ${dayCount} day plan (${days}) for ${firstTime}${city}${travelWith}${occasion} that includes ${hotel}${attractions ? ', '+attractions : ''}${otherAttractions ? ', '+otherAttractions : ''} and restaurants. 
